<?php /**
        ...
        Last modified: 2016-05-16 00:35:07
        Filename: AJC_Data_Edit.php
...
$folder = (isset($_REQUEST['folder']))?htmlspecialchars($_REQUEST['folder']):AJC_ROOT.'/data';
if (is_numeric($folder))
	$folder = AJC_ROOT.'/data/'.$folder;
